...
var fileDescriptor_7be9bf9d675643a6 = []byte{
	...
	0x2d, 0x28, 0xa9, 0x34, 0x32, 0xe5, 0x12, 0x0f, 0x06, 0x29, 0x75, 0x05, 0x2b, 0x0d, 0x01, 0x29,
	0x0d, 0x86, 0xa8, 0x14, 0x92, 0xe2, 0x62, 0x0b, 0x2d, 0x48, 0x49, 0x2c, 0x49, 0x15, 0x62, 0xd3,
	0x03, 0x2b, 0x96, 0x82, 0xd2, 0x4a, 0x0c, 0x4e, 0x3c, 0x51, 0x5c, 0x05, 0xd9, 0xe9, 0xfa, 0x89,
	0x05, 0x99, 0xfa, 0x65, 0x86, 0x49, 0x6c, 0x60, 0x43, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff,
	0x51, 0x66, 0x4c, 0x85, 0x76, 0x00, 0x00, 0x00,
}
...
func (c *smartEnergyTableServiceClient) Update(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/SmartEnergyTableService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedSmartEnergyTableServiceServer) Update(ctx context.Context, req *Empty) (*Empty, error) {
...
func _SmartEnergyTableService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SmartEnergyTableServiceServer).Update(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/SmartEnergyTableService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SmartEnergyTableServiceServer).Update(ctx, req.(*Empty))
	}
