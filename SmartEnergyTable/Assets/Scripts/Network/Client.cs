...
namespace Network
{
    ...
    public class Client
    {
        ...
        /// <summary>
        /// RPC to switch between AR and VR mode.
        /// </summary>
        /// <param name="roomId">the ID of the room where this function should be executed.</param>
        /// <param name="userId">the GUID generated by the client should be corresponding to the master in the room.</param>
        /// <param name="mode">can be AR or VR</param>
        /// <returns></returns>
        internal Empty SwitchViewMode(string roomId, string userId, ViewMode mode)
        {
            var empty = _client.SwitchMode(new ModeSwitch
            {
                RoomUser = new RoomUser
                {
                    Id = roomId,
